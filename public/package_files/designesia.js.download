...
(function($) {
    ...
    $('#custom-owl-slider').parents('section').addClass('owl-slide-wrapper');

    var year  = $('#defaultCountdown').data('y');
	var month = $('#defaultCountdown').data('m') - 1;
	var day   = $('#defaultCountdown').data('d');
	var hour  = $('#defaultCountdown').data('h');
	var mins  = $('#defaultCountdown').data('mi');
    $('#defaultCountdown').countdown({until: new Date(year, month, day, hour, mins), labels: ['Years', 'Months', 'Weeks', 'Days', 'Hours', 'Minutes', 'Seconds'], labels1: ['Year', 'Month', 'Week', 'Day', 'Hour', 'Minute', 'Second'] }); // year, month, date, hour
