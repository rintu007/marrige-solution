...
<?php $chatto = $shop->chattoAll; ?>
  <div class="chatsLastPage" data-lastpage="{{$chatto->lastPage()}}" data-url ="{{route('chatParticipantsOfShopAuto',['shop'=>$shop])}}"></div>
  <ul class="products-list product-list-in-box">
  <div class="chatsAuto">
  @include('chat::ajaxBlades.chatsAllOfShop')
  </div>
  </ul>
