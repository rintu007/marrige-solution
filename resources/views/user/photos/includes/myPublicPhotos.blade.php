...
<h4 class="card-header {{$u->isMale() ? 'card-header-info' : 'card-header-rose'}}"><a class="w3-text-white" href="{{route('user.myAllPhotos', 'public')}}"><i class="fa fa-image"></i> &nbsp; Public Photos All</a>
</h4>
...
@if ($u->moreThanSixPublicPhotos())
<br>

<div class="text-center">
    <a class="w3-btn w3-round w3-border w3-border-blue w3-white btn-xs" href="{{route('user.myAllPhotos', 'public')}}">See All Public Photos</a>
</div>
@endif
