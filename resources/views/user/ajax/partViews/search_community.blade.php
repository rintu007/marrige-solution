<div class="box box-widget mb-0" style="min-height: 600px;">
    ...
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-th"></i> Community Search</h3>
    </div>
    ...
    <div class="box-body" style="background: #ddd;">
      ...
      <div class="w3-border w3-border-purple w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <form class="cat-subcat-form" action="{{ route('user.userSearchByCommunityAjax') }}" method="post">
                {{csrf_field()}}


                <div class="form-group ">
                        <label for="professions">Select Community/Religion </label>

                        {{-- ID: 4  Religion --}}

                        <div class="form-group form-group-sm {{ $errors->has('community') ? ' has-error' : '' }}">
            <label for="community">Community/Religion:</label>
            
            <select class="form-control form-group-sm form-check-input-select"    id="community" name="community" >
