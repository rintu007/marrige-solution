...
<!--  Dear {{$user->name}},-->
<!--  We are sorry to say that your account in taslimamarriagemedia.com is temporarily deactivated. -->

<!--  If you want to use your account again, please contact us at +8801972006691.-->
...
<!--  <p style="font-size: 20px;"><a style="color:#222;text-decoration: none;" href="{{url('/')}}">{{ $_SERVER['SERVER_NAME'] }}</a></p>-->
<!--  <p style="color:#222;">Copyright © {{date('Y')}} {{ $_SERVER['SERVER_NAME'] }} | All rights reserved. </p>-->
<!-- </div>-->
<!--</div>-->
...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Hello <strong>{{$user->name}}</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="line-height: 1.5; word-break: break-word; font-size: 14px; mso-line-height-alt: 21px; margin: 0;"><span style="font-size: 14px;">We are sorry to say that your account in <a href="https://www.taslimamarriagemedia.com/">taslimamarriagemedia.com</a>  is temporarily deactivated. </span></p>
...
<p style="line-height: 1.5; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;"> </p>
<p style="line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">
    If you want to use your account again,<br/>
</span><span style="font-size: 16px;"> please contact <br/></span><span style="font-size: 16px;">{{Auth::user()->name}} <br/></span><span style="font-size: 16px;">Phone:{{Auth::user()->mobile}}</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
