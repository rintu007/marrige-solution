...
<!--  Dear {{$user->name}},-->
<!--  Congratulations, Your account in taslimamarriagemedia.com is activated again. -->

<!--  You can login and now and find your soulmate, To know more, please contact us at +8801972006695.-->
...
<p style="font-size: 22px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Dear <strong>{{$user->name}}</strong></span></p>
