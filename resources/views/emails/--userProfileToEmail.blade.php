...
<!--  <p>Hello {{$email}}, <br> <br>-->
<!--  Meet a few members matching your queries.</p> -->
...
<!--                  <img src="{{$message->embed($item->latestCheckedPP())}}" alt="" width="120" height="120">-->
<!--                  </td>-->
...
<p style="line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px; padding-top: 20px;">Best Regards,<br/>
