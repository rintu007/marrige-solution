...
<!-- Info boxes -->
      ...
      <div class="box box-widget">
          <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-edit"></i> Update Page Part <span class="label label-default">{{ $it->title }}</span> of  <span class="label label-default">{{ $page->page_title }}</span> Page</h3>
          </div>
