    ...
    <section class="content-header">
      <h1>
        Home
        <small>Send Cv to Given Email</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> Send Cv to Given Email</li>
      </ol>
    </section>
        ...
        <div class="col-sm-3">
          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <form method="post" action="{{ route('admin.selectCvUsers') }}" class="form-select-mails-user">
        ...
        <div class="col-sm-9">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="padding-left:8px;">
              ...
              <h3 class="box-title">
                Email: <input type="email" name="email" placeholder="Email Address" style="width: 250px;" required> (Maximum 20 cv files will be sent per mail)
              </h3> 
