    ...
    <section class="content-header">
      <h1>
        Home
        <small>Send Cv To User</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> Send Cv To User</li>
      </ol>
    </section>
        ...
        <div class="col-sm-3">
          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <form method="post" action="{{ route('admin.selectCvUsersForUser', $user) }}" class="form-select-mails-user">
        ...
        <div class="col-sm-9">
          ...
          <div class="box box-primary">
            <div class="box-header with-border" style="padding-left:8px;">
              ...
              <h3 class="box-title">
               <b>CV To: <input type="hidden" name="email" value="{{ $user->email }}">
                

              {{$user->email}} </b>, Gender: {{ $user->gender}}, Age: {{ $user->age() }}, Religion: {{ $user->religion }}, Profession: @if ($user->personalInfo)
                ...
                <br>
                  ...
                  <b class="w3-small">
                    (Maximum 20 cv files will be sent per mail)
                  </b>
