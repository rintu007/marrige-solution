            ...
            {{csrf_field()}}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="box box-widget">
                    <div class="box-body">
                      <img class="img-responsive" src="{{ asset('storage/stories/'. $story->image_name) }}" alt="{{ $story->title }}">
                    </div>
                  </div>
                ...
                <span class="help-block">
                  <strong>Image Ratio Need (w/h): 800 / 400, </strong> If new image upload, old image will be deleted.
                        </span>
