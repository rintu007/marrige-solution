  ...
  <div class="box-body">
    <form class="form-horizontal" method="post"  action="{{route('admin.quickSmsSend')}}">        
                ...
                <div class="form-group {{ $errors->has('sender_number') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ old('sender_number') ?: 'T.M. Media'}}" name="sender_number" class="form-control" id="sender_number" placeholder="Sender Number">
                ...
                <div class="form-group{{ $errors->has('masking') ? ' has-error' : '' }}"> 
                  <div class="col-sm-offset-3 col-sm-9">
                    <div class="checkbox">
                      <label><input type="checkbox" name="masking" >  Masking (T.M. Media) </label>
