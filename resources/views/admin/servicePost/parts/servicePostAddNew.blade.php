    ...
    <section class="content"> 
      ...
      <form  method="post" action="{{route('admin.servicePostNewPost')}}" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group {{ $errors->has('feature_image') ? ' has-error' : '' }}">
      ...
      <div class="col-sm-8">
        ...
        <span class="help-block">Image Dimention 150px X 150px or larger and Ratio 2/2.</span>
