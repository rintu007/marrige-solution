...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('welcome.postDivision',[$div, $div->title])}}">{{$div->title}} Division</a></li> 
  @if($dist)
   <li><a href="#">{{$dist->title}} District</a></li>
  @endif 
  @if($thana)
  <li><a href="#">{{$thana->title}} Thana</a></li>
  @endif          
</ol>
...
<div class="box box-widget" style="padding: 0;">
  <div class="box-body" style="min-height: 500px;padding: 0;">
    ...
    @include('blog.includes.search.divSearchInDivPage')
  ...
  <div class="row">
    @foreach($posts2 as $post)
      ...
      <div class="col-sm-8">
         ...
         <div class="text-center lead-post" style="">
                    <img class="img-responsive" border="0" style="width: 100%;" alt="{{$post->title}}" title="{{$post->title}}" src="{{ route('imagecache', [ 'template'=>'cplg','filename' => $post->fiName() ]) }}">
    ...
    <div class="box box-widget" style="padding: 0;">
          <div class="box-body box-profile" style="padding: 0;">
            <img class="img-responsive" src="{{ route('imagecache', [ 'template'=>'cpmd','filename' => $post->fiName() ]) }}" alt="User profile picture">
