...
<div class="container margin-50">
    ...
    <div class="row padding-0">
        ...
        <div class="col-md-8 col-sm-12 center-block bg-warning ">
            ...
            <form class="padding-0-30 margin-bottom-20" method="POST" action="{{ route('signup.storeRelativeInfo') }}"
                role="form">
                @csrf
                ...
                <div class="form-group row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="">
                                    <div class="radio">
                                        <label>
                                            <input class="relaFromCheck" {{ 1 == old('relative_side') ? 'checked' : '' }} type="radio" name="relative_side"
                                                id="relative_side" value="1">
                                            Parternal Side
                                        </label>
                                        <label>
                                            <input class="relaFromCheck" {{ 2 == old('relative_side') ? 'checked' : '' }} type="radio" name="relative_side"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <div class="radio">
                                    <label>
                                        <input class="genderChek" {{ 1 == old('gender') ? 'checked' : '' }} type="radio" name="gender" id="gender"
                                            value="1">
                                        Uncle
                                    </label>
                                    <label>
                                        <input class="genderChek" {{ 2 == old('gender') ? 'checked' : '' }} type="radio" name="gender" id="gender"
                                            value="2">
                                        Aunty
                                    </label>
                                </div>
