      ...
      <div class="card border-0">
        ...
        <div class="card-body arrival-card pl-0 ml-0">
          ...
          <p class="card-text arrival-text p-0 m-0 pb-2">
            ...
            {{ $item->education }}</p>
          <a href="{{ \App\Common::getUserUrl($item->id) }}" class="btn p-0 m-0 text-bold btn p-2 m-0 text-bold btn-block w3-button w3-red w3-hover-red">View
            Profile</a>
        </div>
      </div>
    </div>
