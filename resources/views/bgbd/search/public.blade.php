    ...
    <div class="col-lg-3 col-sm-6 col-md-4 pl-sm-0 ml-sm-0 pr-2">
      <div class="card border-0">
        <div class="card-image">
          ...
          <img src="{{ $item->photo  }}" class="image card-img-top"
            alt="{{ $item->name }}" />
          ...
          @else
          @if ($item->gender == 1)
          <img src="{{ url('assets/defaults/male.png') }}" class="image card-img-top" alt="{{ $item->name }}" />
          @else
          <img src="{{ url('assets/defaults/female.png') }}" class="image card-img-top" alt="{{ $item->name }}" />
          @endif
          @endif
          <div class="middle">
            <div class="text">
...
@include('hasan.subpage.public-js')
@endsection