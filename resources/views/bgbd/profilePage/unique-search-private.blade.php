                ...
                <table class="table table-condensed rounded mytable table-mobile">
                  ...
                  @foreach ($education as $edu)
                    ...
                    <tr>
                      ...
                      <td>
                        {!! Auth::user()->premium?$edu->institution_name:'<span class="badge badge-danger">Premium member only</span>' !!}</td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <hr>
                    <button type="button" class="btn btn-success btn-sm pp-address" id="pp-address-{{ isset($user)??$user->id }}">Send request for Present and Permanent Address</button>
                  </div>
