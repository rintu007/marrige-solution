...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('users.editprofile.siblings.update', $sibling->id) }}" method="POST" role="form">
                @csrf
                <div class="form-group row">
                    <div class="col-md-6">
                        <label for="siblingposition" class="col-form-label">Sibling Position</label>
                        <input class="form-control" type="number" name="siblingposition" id="siblingposition" value="{{ $sibling->sibling_position}}">
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <div class="radio">
                                <label>
                                    <input {{  $sibling->gender == 1 ? 'checked' : '' }} type="radio" name="gender" id="gender" value="1">
                                    Male
                                </label>
                                <label>
                                    <input {{ $sibling->gender == 2 ? 'checked' : '' }} type="radio" name="gender" id="gender" value="2">
                                    Female
                                </label>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input value="{{$sibling->sibling_name }}" id="relative" name="sibling_name" placeholder="Name" class="form-control here"
                                type="text">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="">
                            <input  {{ $sibling->living_status == 1? 'checked' : '' }} type="radio" name="sibling_living" id="sibling_living1" value="1" class="liveStatusClass" />
                            Alive
                            <input  {{ $sibling->living_status == 2 ? 'checked' : '' }} type="radio" name="sibling_living" id="sibling_living" value="2" class="liveStatusClass" />
                            Passed
                            Away
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="">
                            <input {{ $sibling->marital_status == 1 ? 'checked' : '' }}  type="radio" id="marital_status1" name="marital_status" class="marital_status" value="1" />
                            Married
                            <input {{ $sibling->marital_status == 2 ? 'checked' : '' }}  type="radio" name="marital_status" class="marital_status" value="2" />
                            Not
                            Married
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <select name="sibling_profession" id="sibling_profession" class="form-control">
                                    ...
                                    <option {{ $sibling->sibling_profession == $key ? 'selected' :'' }} value="{{ $key }}">{{ $item }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div id="ProfDetailsIdHide" style="display:none">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ $sibling->sibling_designation }}" id="sibling_designation" name="sibling_designation" placeholder="Designation"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ $sibling->sibling_organization }}" id="sibling_organization" name="sibling_organization" placeholder="Organization Name"
                                        class="form-control here" type="text">
                ...
                <div class="spouse-infos">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input value="{{ $sibling->sibling_spouse_name }}" id="relative" name="sibling_spouse_name" placeholder="Name" class="form-control here"
                                    type="text">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input {{ $sibling->sibling_spouse_living_status == 1 ? 'checked' : '' }} type="radio" name="sibling_spouse_living" id="sibling_spouse_living1" value="1"
                                    class="liveStatusClassRS" />
                                Alive
                                <input  {{ $sibling->sibling_spouse_living_status == 2 ? 'checked' : '' }} type="radio" name="sibling_spouse_living" id="sibling_spouse_living" value="2"
                                    class="liveStatusClassRS" />
                                Passed Away
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <select name="sibling_spouse_profession" id="sibling_spouse_profession" class="form-control"">
                                     <option value="">Select One</option>
                                        @foreach (professionType() as $key=>$item)
                                        <option {{ $sibling->sibling_spouse_profession == $key ? 'selected' : '' }} value="{{ $key }}">{{ $item }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div id="relativeSpouseProfession" style="display: none">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input value="{{ $sibling->sibling_spouse_designation }}" id="sibling_spouse_designation" name="sibling_spouse_designation"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input value="{{ $sibling->sibling_spouse_organization }}" id="sibling_spouse_organizaion" name="sibling_spouse_organizaion"
...
@include('sections.javascripts.editSiblings')
@endsection
