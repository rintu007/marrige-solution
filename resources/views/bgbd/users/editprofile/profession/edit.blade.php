...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('users.editprofile.profession.update') }}" class="padding-0-30">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <select name="profession" id="profession" class="form-control" required="required">
                            ...
                            <option {{ $userProfession->profession_type == $key ? 'selected' : '' }} value="{{ $key }}">{{ $value }}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <div id="professiondetails" class="allHideClass" style="display:none">
                            ...
                            <div class="">
                                <select data-oldval="{{ $userProfession->profession_type_details ?? 0 }}" name="profession_details" id="profession_details"
                                    class="form-control">
                                </select>
                ...
                <div id="ProfDetailsIdHide" style="display:none">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input value="{{  $userProfession->designation > 0 ? $userProfession->designation : '' }}" type="text" name="designation" id="designation" placeholder="Designation" class="form-control">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input value="{{ $userProfession->org_name > 0 ? $userProfession->org_name : ''   }}" type="text" name="orgName" id="orgName" placeholder="Organization" class="form-control">
                ...
                <div class="form-group row">
                    <div class="col-xs-6">
                       <a class="btn btn-danger btn-block btn-success"  href="{{ route('users.editprofile.profession.view') }}">Cancel Edit</a>
                    </div>
                    <div class="col-xs-6">
