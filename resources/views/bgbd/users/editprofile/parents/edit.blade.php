...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        <div class="panel-heading title">
            ...
            <a href="{{ route('users.editprofile.parents.view') }}" type="button" class="btn btn-danger btn-sm pull-right">
                <span class="fa fa-backward"></span> Cancel Edit
            </a>
        </div>

        <div class="panel-body">
            <form method="POST" action="{{ route('users.editprofile.parents.update', $parent->id ) }}" class="padding-0-30">
                @csrf
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input value="{{ $parent->parent_name }}" id="fname" name="fname" placeholder="Name" class="form-control here"
                                type="text">
                            @if ($errors->has('fname'))
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input {{ $parent->living_status == 1 ? 'checked':'' }} type="radio" name="flstatus" id="flstatus1"
                                value="1" class="fatherLiveStatusRadio" />
                            Alive
                            <input {{ $parent->living_status == 2 ? 'checked':'' }} type="radio" name="flstatus" id="flstatus"
                ...
                <div id="liveStausLinkToServiceDivId" style="display:none">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input {{ $parent->service_status == 1 ?'checked' : '' }} type="radio" id="fsrvstatus1"
                                    class="fsrvstatus" name="fsrvstatus" value="1" />In Service
                                <input {{ $parent->service_status == 2 ?'checked' : '' }} type="radio" id="fsrvstatus2"
                                    class="fsrvstatus" name="fsrvstatus" value="2" />Retired
                                <input {{ $parent->service_status == 3 ?'checked' : '' }} type="radio" class="fsrvstatus"
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <select name="fprofession" id="fprofession" class="form-control"">
                                    ...
                                    <option {{ $parent->profession == $key ?'selected':'' }} value="{{ $key }}">{{
                                        $item }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div id="professiondetails" class="allHideClass" style="display:none">
                                ...
                                <div class="">
                                    <select data-oldval="{{ $parent->profession_details	 ?? 0 }}" name="profesion_details"
                    ...
                    <div id="ProDesignOrgNameDiv" style="display:none">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ $parent->designation }}" id="fdesignation" name="fdesignation"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ $parent->organization_name }}" id="forgname" name="forgname"
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <input value="{{ $parent->more_info }}" id="fmoreinfo" name="fmoreinfo" placeholder="More Information"
...
@include('sections.javascripts.editParent')
@endsection
