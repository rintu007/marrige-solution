                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="">
                                    <select name="fprofession" id="fprofession" class="form-control"">
                                        ...
                                        <option {{ old('fprofession') == $key ?'selected':'' }} value="{{ $key }}">{{ $item }}</option>
                                        @endforeach
                                    </select>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                            <div class="col-xs-12">
                                ...
                                <div class="">
                                    <input value="{{ old('mname') }}" id="mname" name="mname" placeholder="Mother's Name" class="form-control here"
                                         type="text">
                                    @if ($errors->has('mname'))
                                    <span class="text-danger" role="alert">
                        ...
                        <div id="motherliveStausLinkToServiceDivId" style="display:none">
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="">
                                        <input {{ old('msrvstatus') == 1 ?'checked' : '' }} type="radio" id="msrvstatus1" class="msrvstatus"
                                            name="msrvstatus" value="1" />In Service
                                        <input {{ old('msrvstatus') == 2 ?'checked' : '' }} type="radio" id="msrvstatus2" class="msrvstatus"
                                            name="msrvstatus" value="2" />Retired
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-12">
                                    <div id="professiondetails" class="allHideClass" style="display:none">
                                        ...
                                        <div class="">
                                            <select data-oldval="{{ old('mother_profesion_details') ?? 0 }}" name="mother_profesion_details" id="mother_profesion_details" class="form-control">
                                            </select>
