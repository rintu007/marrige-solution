...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('users.editprofile.address.updateDeshi', $address->id) }}" class="padding-0-30">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        ...
                        <select name="divisions" id="divisions" class="form-control" required="required">
                            ...
                            <option {{ $address->home_division == $division->id ? 'selected' : '' }} value="{{  $division->id }}">{{
