...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="POST" action="{{ route('users.editprofile.address.updateBideshi', $address->id) }}" class="padding-0-30">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <select name="birthcountry" id="birthcountry" class="form-control" required="required">
                            ...
                            <option {{ $address->nrb_birth_country  ==  $country->id  ? 'selected' : ''}}  value="{{  $country->id }}">{{
                                $country->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="growupcountry" id="growupcountry" class="form-control" required="required">
                            <option>Select ...</option>
                            @foreach ($countries as $country)
                            <option {{ $address->nrb_growing_up_country  == $country->id ? 'selected' : ''}} value="{{  $country->id }}">
                                {{ $country->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <div class="">
                            <input value="{{ $address->nrb_social_no  }}" id="socialno" name="socialno" placeholder="Resident Country Social id"
                                class="form-control here" type="text">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="immigrationstatus" id="immigrationstatus" class="form-control" required="required">
                            ...
                            <option {{ $address->nrb_immigration_status	 == $key ? 'selected' : ''}} value="{{  $key }}">
                                {{ $value }}</option>
                            @endforeach
                        </select>
