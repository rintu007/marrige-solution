            ...
            <form action="{{ route('users.editprofile.relatives.insert') }}" method="POST" role="form">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <div class="radio">
                                <label>
                                    <input {{ 1 == old('relativetype') ? 'checked' : '' }} type="radio" name="relativetype"
                                        id="relativetype" value="1">
                                    Parternal Side
                                </label>
                                <label>
                                    <input {{ 2 == old('relativetype') ? 'checked' : '' }} type="radio" name="relativetype"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <div class="radio">
                                <label>
                                    <input {{ 1 == old('gender') ? 'checked' : '' }} type="radio" name="gender" id="gender"
                                        value="1">
                                    Male
                                </label>
                                <label>
                                    <input {{ 2 == old('gender') ? 'checked' : '' }} type="radio" name="gender" id="gender"
                                        value="2">
                                    Female
                                </label>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input value="{{ old('relative_name') }}" id="relative" name="relative_name" placeholder="Name" class="form-control here"
                                type="text">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="">
                            <input {{ 1 == old('relative_living') ? 'checked' : '' }} type="radio" name="relative_living"
                                id="relative_living1" value="1" class="liveStatusClass" />
                            Alive
                            <input {{ 2 == old('relative_living') ? 'checked' : '' }} type="radio" name="relative_living"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <select name="relative_profession" id="relative_profession" class="form-control">
                                    ...
                                    <option {{ old('relative_profession') == $key ?'selected': '' }}  value="{{ $key }}">{{ $item }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div id="professiondetails" class="allHideClass" style="display:none">
                                ...
                                <div class="">
                                    <select  data-oldval="{{ old('relative_profession') ?? 0 }}"  name="profession_details" id="profession_details" class="form-control">
                    ...
                    <div id="ProfDetailsIdHide" style="display:none">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ old('relative_designation') }}" id="relative_designation" name="relative_designation" placeholder="Designation"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <input value="{{ old('relative_organization') }}" id="relative_organization" name="relative_organization" placeholder="Organization Name"
                                        class="form-control here" type="text">
                ...
                <div class="spouse-infos">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input value="{{ old('relative_spouse_name') }}" id="relative" name="relative_spouse_name" placeholder="Name" class="form-control here"
                                    type="text">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                <input {{ 1 == old('relative_spouse_living') ? 'checked' : '' }} type="radio" name="relative_spouse_living"
                                    id="relative_spouse_living1" value="1" class="liveStatusClassRS" />
                                Alive
                                <input {{ 2 == old('relative_spouse_living') ? 'checked' : '' }} type="radio" name="relative_spouse_living"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <select name="relative_spouse_profession" id="relative_spouse_profession" class="form-control"">
                                        ...
                                        @foreach (professionType() as $key=>$item)
                                        <option {{ old('relative_spouse_profession') == $key ?'selected':'' }}  value="{{ $key }}">{{ $item }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div id="relativeSpouseProfession" style="display: none">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input value="{{ old('relative_spouse_designation') }}" id="relative_spouse_designation" name="relative_spouse_designation"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        <input value="{{ old('relative_spouse_organizaion') }}" id="relative_spouse_organizaion" name="relative_spouse_organizaion"
...
@include('sections.javascripts.createRelaive')
@endsection
