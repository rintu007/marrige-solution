...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        <div class="panel-heading title">
            <span class="h3 bold-text">Bride (Partner) Preferences</span>
                ...
                <table class="table table-light">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="bold-text">{{ $userinfo->job_allow_for_bride === '1' ? 'Yes, can do job.' : 'No,
                                cannot do job' }}</td>
                        </tr>
                        ...
                        <tr>
                            <td width="200">
                                Hijab and Burka wearing

                            </td>
                            <td class="bold-text">{{ $userinfo->hijab === '1' ? 'Yes, must wear hijab and Burka.' :
                                'No, wearing hijab and Burka is not nesseray.' }}</td>
                        </tr>
