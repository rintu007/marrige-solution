...
<div class="col-md-9 card">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('users.editprofile.education.update', $userEdu->id) }}" class="padding-0-30">
                @csrf
                ...
                <div class="form-group row currentstudent">
                    <div class="col-sm-6">
                        ...
                        <input id="result" name="semester" placeholder="semester" class="form-control here" required="required"
                            type="text">
