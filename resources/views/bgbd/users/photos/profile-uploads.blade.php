...
<div class="container m-b-150 m-t-50">
  <div class="row">
    ...
    <div class="col-sm-9">
      ...
      <form action="{{ route('users.changeProfilePicPost') }}" method="post" enctype="multipart/form-data">
          @csrf
        ...
        {{-- <form action="{{ route('users.photos.changeProfilePictureUpdate') }}" method="post">
          @csrf
