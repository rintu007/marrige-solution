              ...
              <form class="padding-0-30 margin-bottom-20" method="POST" action="{{ $formAction }}" role="form">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input class="uk-input" type="number" name="siblingposition" id="siblingposition"
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="">
                      <div class="radio">
                        <label>
                          <input class="gendercheck" {{ 1 == old('gender') ? 'checked' : '' }} type="radio"
                            name="gender" id="gender" value="1">
                          Brother
                        </label>
                        <label>
                          <input class="gendercheck" {{ 2 == old('gender') ? 'checked' : '' }} type="radio"
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="uk-form-controls religion_caste_lg uk-form-custom uk-form-controls-lg" uk-form-custom="target: > * > span:first-child">
                        <select name="sibling_profession" id="sibling_profession" class="uk-input">
                          <option value="0">Select One</option>
                          @foreach (professionType() as $key=>$item)
                          <option {{ old('sibling_profession') == $key ?'selected': '' }} value="{{ $key }}">{{ $item }}
                          </option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="">
                        ...
                        <input {{ 2 == old('sibling_spouse_living') ? 'checked' : '' }} type="radio"
                          name="sibling_spouse_living" id="sibling_spouse_living" value="2" class="liveStatusClassRS" />
                        Passed Away
                  ...
                  <div id="liveStatusToLinkRelProfessionIdRS" style="display:none">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        ...
                        <div class="uk-form-controls religion_caste_lg uk-form-custom uk-form-controls-lg" uk-form-custom="target: > * > span:first-child">
                          <select name="sibling_spouse_profession" id="sibling_spouse_profession" class="uk-input">
                            <option value="">Select One</option>
                            @foreach (professionType() as $key=>$item)
                            <option {{ old('sibling_spouse_profession') == $key ?'selected':'' }} value="{{ $key }}">
                              {{ $item }}</option>
                            @endforeach
                          </select>
                          <button class="uk-button birth_day_btn uk-button-default px-0 mx-0 " type="button" tabindex="-1">
                      ...
                      <div class="col-md-6 spouse_profe">
                        <label for="fdesignation" class=" col-form-label">Brother's / Sister's Spouse Profession
                          Details</label>
                        <div class="">
                          <input value="{{ old('spouse_profession_details') }}" name="spouse_profession_details"
                            placeholder="Profession Details" class="uk-input here" type="text">
                        </div>
                      </div>
                    </div>
