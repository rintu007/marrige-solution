<div class="box box-widget">
     	...
     	<form method="post" action="{{route('editor.postUpdate',$post)}}" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="form-group">
      <label for="extra_file" class="control-label"></label>
        ...
        <div class="radio">
          <label><input type="radio" name="division" value=""> বিভাগ নেই</label>
        </div>
        @foreach($divs as $div)
        <div class="radio">
    ...
    <div class="form-group">
            <label for="title" class="control-label">District </label>
              ...
              style="width: 100%;" > 
              @if($dist)
              <option selected="selected">{{ $dist->title }}</option>
              @endif
        ...
        <div class="form-group">
            <label for="title" class="control-label">Thana (উপজেলা) </label>
              ...
              style="width: 100%;" > 
              @if($thana)
              <option selected="selected">{{ $thana->title }}</option>
              @endif
            ...
            <span class="help-block">At First Select District.</span>
                ...
                <div class="w3-display-topright" style="padding-right: 10px;padding-top: 10px;">
                  <a class="btn btn-primary btn-xs"  href="{{route('editor.featureImageDelete',$post)}}"><i class="fa fa-times"></i></a>
                </div>
