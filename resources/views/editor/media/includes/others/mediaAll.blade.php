				  ...
				  <div class="media-left">
				    <a href="#">
				    	<div class="w3-display-container">
				    		...
				    		<div class="w3-display-topright"><a onclick="return confirm('Do you really want to delete this media?');" style="margin-right: 4px;margin-top: 3px;" class="btn btn-default btn-xs" title="Delete" href="{{route('editor.mediaDelete',$media)}}"><i class="fa fa-times"></i></a></div>
